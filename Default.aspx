...
<body>
  <main class="shell">
    ...
    <section id="game" hidden>
      ...
      <nav class="tabs game-tabs">
        ...
        <button class="tab" data-tab="rift" id="rift-tab" hidden>주간 균열</button>
      ...
      <section class="panel guide" id="guide-panel">
        ...
        <article class="guide-block">
          ...
          <ul>
            ...
            <li>관문 보스를 1마리 처치할 때마다 일일 시간이 10분 증가합니다.</li>
          </ul>
        </article>
        <article class="guide-block">
          <h3>직접 사냥</h3>
        ...
        <article class="guide-block" id="collection-guide" hidden>
          ...
          <p class="guide-note">수집한 몬스터 카드를 누르면 상세 정보를 볼 수 있고, 해당 몬스터를 프로필로 지정할 수 있습니다. 지정한 프로필은 내 닉네임과 랭킹 목록 앞에 표시되며, 다른 유저도 프로필 이미지를 눌러 크게 볼 수 있습니다.</p>
        </article>
        <article class="guide-block">
          <h3>강화</h3>
          <ul>
  ...
  <script src="Scripts/game.js?v=20260611-5"></script>
</body>
</html>
