...
public sealed class GameCatalog
{
    ...
    [
        new(0, "초보자의 숲", 0, 5_000, 100, 3, 460),
        new(1, "버려진 광산", 3, 7_000, 140, 6, 1_060),
        new(2, "깊은 동굴", 6, 10_000, 200, 9, 2_440),
        new(3, "황폐한 성터", 9, 15_000, 300, 12, 5_600),
        new(4, "얼어붙은 계곡", 12, 20_000, 450, 15, 12_880),
        new(5, "화염 지대", 15, 30_000, 650, 18, 29_600),
        new(6, "망자의 성", 18, 45_000, 900, 20, 51_580),
        new(7, "심연의 입구", 20, 65_000, 1_250, 22, 89_880),
        new(8, "용의 둥지", 22, 90_000, 1_700, 23, 118_640),
        new(9, "천공의 신전", 23, 120_000, 2_300, 25, 206_720),
        new(10, "별이 잠든 유적", 25, 160_000, 3_100, 27, 360_180),
        new(11, "끝없는 균열", 27, 210_000, 4_200, null, null)
    ];
