...
<body>
      ...
      <div>
        <section class=""panel admin-panel active"" id=""abuse-panel"">
          <div class=""section-title"">
            <h2>실시간 이상행동 후보</h2>
            <span>최근 7일 로그 기준</span>
          </div>
          <p class=""collection-description"">
            비정상 재화, 경험치, 강화도, 보호권 값을 자동 후보로 올립니다.
            최종 판단 후 유저 차단 버튼으로 조치하세요.
          </p>
          <div class=""admin-table-wrap"">
            <table>
              <thead>
                <tr><th>유저</th><th>행동</th><th>사유</th><th>시간</th><th>조치</th></tr>
              </thead>
              <tbody id=""abuse-body""></tbody>
            </table>
          </div>
        </section>
        ...
        <section class=""panel admin-panel"" id=""users-panel"">
          ...
          <div class=""admin-table-wrap"">
            <table>
              <thead>
                <tr><th>유저</th><th>상태</th><th>레벨</th><th>골드</th><th>강화</th><th>조치</th></tr>
              </thead>
        ...
        <section class=""panel admin-panel"" id=""event-panel"">
          <div class=""section-title"">
            <h2>핫타임 배율</h2>
            <span>한국시간 기준으로 서버 보상 계산에 즉시 반영</span>
          </div>
          <form class=""admin-form"" id=""hot-time-form"">
            <label>
              사용 여부
              <select id=""hot-enabled"">
            ...
            <label>
              골드 배율
              <input id=""hot-gold"" type=""number"" step=""0.1"" min=""0.1"" max=""20"" />
            </label>
            <label>
              경험치 배율
              <input id=""hot-exp"" type=""number"" step=""0.1"" min=""0.1"" max=""20"" />
            </label>
            <div class=""hot-preset-row full"">
              <button type=""button"" onclick=""setHotMultiplier(1)"">1배</button>
              <button type=""button"" onclick=""setHotMultiplier(2)"">2배</button>
              <button type=""button"" onclick=""setHotMultiplier(3)"">3배</button>
              <button type=""button"" onclick=""setHotMultiplier(5)"">5배</button>
            </div>
            <label>
              시작 시간(한국)
              <input id=""hot-start"" type=""datetime-local"" />
            </label>
            <label>
              종료 시간(한국)
              <input id=""hot-end"" type=""datetime-local"" />
            </label>
            <div class=""hot-preset-row full"">
              <button type=""button"" onclick=""setHotDuration(1)"">지금부터 1시간</button>
              <button type=""button"" onclick=""setHotDuration(2)"">지금부터 2시간</button>
              <button type=""button"" onclick=""setHotDuration(4)"">지금부터 4시간</button>
              <button type=""button"" onclick=""setHotTonight()"">오늘 20~22시</button>
            </div>
        ...
        <section class=""panel admin-panel"" id=""enhancements-panel"">
          <div class=""section-title"">
            <h2>강화 확률</h2>
            <span>저장 즉시 강화 로직과 확률표에 반영</span>
          </div>
          ...
          <p class=""collection-description"">
            확률은 0.3 = 30% 형식으로 입력합니다. 세 확률의 합은 반드시 1이어야 합니다.
          </p>
          <div class=""admin-table-wrap"">
            <table>
              <thead>
                <tr><th>단계</th><th>비용</th><th>성공</th><th>유지</th><th>파괴</th><th>편집</th></tr>
              </thead>
              <tbody id=""enhancement-body""></tbody>
            </table>
          </div>
        </section>
        ...
        <section class=""panel admin-panel"" id=""monsters-panel"">
          ...
          <form class=""admin-form"" id=""monster-form"">
            ...
            <label>
              등급
              <select id=""monster-grade"">
                <option value=""normal"">일반</option>
                <option value=""elite"">정예</option>
                <option value=""golden"">황금</option>
              </select>
            </label>
          ...
          <div class=""admin-table-wrap"">
            <table>
              <thead>
                <tr><th>키</th><th>구성</th><th>이름</th><th>이미지</th><th>편집</th></tr>
              </thead>
              <tbody id=""monster-body""></tbody>
            </table>
          </div>
        </section>
        ...
        <section class=""panel admin-panel"" id=""weapons-panel"">
          ...
          <div class=""admin-table-wrap"">
            <table>
              <thead>
                <tr><th>키</th><th>이름</th><th>이미지</th><th>편집</th></tr>
              </thead>
        ...
        <section class=""panel admin-panel"" id=""logs-panel"">
          <div class=""section-title"">
            <h2>관리자 행동 로그</h2>
            <span>권한/배율/콘텐츠 변경 기록</span>
          </div>
          <div class=""admin-table-wrap"">
            <table>
              <thead>
                <tr><th>운영자</th><th>행동</th><th>대상</th><th>시간</th></tr>
              </thead>
  ...
  <script src=""/Scripts/operator.js?v=20260604-1""></script>
</body>
</html>";
    }
}
