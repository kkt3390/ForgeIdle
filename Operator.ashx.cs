  ...
  <main class=""shell"">
    ...
    <section class=""admin-layout"">
      ...
      <div>
        ...
        <section class=""panel admin-panel"" id=""enhancements-panel""><div class=""section-title""><h2>강화 확률</h2><span>저장 즉시 강화 로직과 확률표에 반영</span></div><form class=""admin-form"" id=""enhancement-form""><label>현재 단계<input id=""enhancement-level"" type=""number"" min=""0"" max=""29"" /></label><label>비용<input id=""enhancement-cost"" type=""number"" min=""0"" /></label><label>성공 확률<input id=""enhancement-success"" type=""number"" step=""0.0001"" min=""0"" max=""1"" /></label><label>유지 확률<input id=""enhancement-keep"" type=""number"" step=""0.0001"" min=""0"" max=""1"" /></label><label>파괴 확률<input id=""enhancement-destroy"" type=""number"" step=""0.0001"" min=""0"" max=""1"" /></label><label>사용 여부<select id=""enhancement-enabled""><option value=""true"">사용</option><option value=""false"">비활성</option></select></label><button class=""primary full"" type=""submit"">강화 확률 저장</button></form><p class=""collection-description"">확률은 0.3 = 30% 형식으로 입력합니다. 세 확률의 합은 반드시 1이어야 합니다.</p><div class=""admin-table-wrap""><table><thead><tr><th>단계</th><th>비용</th><th>성공</th><th>유지</th><th>파괴</th><th>편집</th></tr></thead><tbody id=""enhancement-body""></tbody></table></div></section>
